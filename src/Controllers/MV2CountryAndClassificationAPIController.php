 ...
 */
class MV2CountryAndClassificationAPIController extends BaseController {

    /**
     * @var MV2CountryAndClassificationAPIController The reference to *Singleton* instance of this class
     */
    private static $instance;
    
    /**
     * Returns the *Singleton* instance of this class.
     * @return MV2CountryAndClassificationAPIController The *Singleton* instance.
     */
     ...
     */
    public function getCountriesListings () 
    {
        //the base uri for api requests
        $_queryBuilder = Configuration::$BASEURI;
        
        //prepare query string for API call
        $_queryBuilder = $_queryBuilder.'/v2/countries';
        ...
        return $mapper->map($response->body, new Models\GetCountriesListingsResponse());
    }
        
    /**
     * Returns a pair of classification (import and export) systems for trade between two countries
     * @param  string     $destination     Required parameter: The two character ISO code for the destination country
     * @param  string     $source          Required parameter: The two character ISO code for the source country
     * @return mixed response from the API call
     * @throws APIException Thrown if API call fails
     */
    public function getTheSystemForACountry (
                $destination,
                $source) 
    {
        //the base uri for api requests
        ...
        //prepare query string for API call
        $_queryBuilder = $_queryBuilder.'/v2/systems';
        ...
        return $mapper->map($response->body, new Models\GetTheSystemForACountryResponse());
    }
